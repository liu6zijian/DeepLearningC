...
void cnnsetup(CNN* cnn,nSize inputSize,int outputSize)
{
	...
	cnn->C1=initCovLayer(inSize.c,inSize.r,5,1,6); // img_size(c,r), kernel_size, in, out
	inSize.c=inSize.c-mapSize+1; //
	inSize.r=inSize.r-mapSize+1;
	cnn->S2=initPoolLayer(inSize.c,inSize.r,2,6,6,AvePool); // img_size, pool_size, in, out
	inSize.c=inSize.c/2;
	inSize.r=inSize.r/2;
